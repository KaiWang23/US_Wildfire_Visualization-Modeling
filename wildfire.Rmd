...
1. Through url to download the dataset, the data contains 1.88 million wildfires that occurred in the United States from 1992 to 2015. The data is 0.9GB. So we save it in the space avoiding rerun the data.

2. Then we generate the dataset for ploting only with fire size, longitude, latitude, discover time, and continue time. This dataset we only use complete cases for plotting. 
...
1. Here we write plotfire function to plot gif. We use savegif function to impletement the 
