...
1.Interactive map: https://shiny.rstudio.com/gallery/superzip-example.html

2.Leaflet: https://shiny.rstudio.com/gallery/superzip-example.html 

3.Some ggplots: https://www.kaggle.com/captcalculator/wildfire-exploratory-analysis

4.Save gif: https://robjhyndman.com/hyndsight/animations/
